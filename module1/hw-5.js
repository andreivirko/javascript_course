...
// let message = prompt("пожайлуста введите пароль");
// console.log(message);
...
// let pageView = prompt("Сколько дроидов вы хотите купить?");
...
//     console.log('Отменено пользователем!');
// } else {
//     totalPrice = pricePerDroid * pageView;
//     console.log(totalPrice);
// } if (totalPrice > credits) {
//     console.log('Недостаточно средств на счету!');
// } else {
//     console.log(`Вы купили ${pageView} дроидов, на счету осталось ${credits - totalPrice} кредитов.`);
// }
...
// let countryName = prompt("Укажите вашу страну пожайлуста").toLowerCase();
...
//     case "китай":
//         orderPrice = 100;
//         alert(`Доставка в ${countryName} будет стоить ${orderPrice} кредитов`);
//         break;
...
//     default:
//         alert(`В вашей стране ${countryName} доставка не доступна`);
// } 
...
// let input = Number(prompt("Пожайлуста ведите число"));
// let input = +(prompt("Пожайлуста ведите число"));
// console.log(input);

// let total = 0;

// do {
//     input = +(prompt("Пожайлуста ведите ЕЩЕ число"));
//     total += input;
//     console.log(total);
// } while (input);
